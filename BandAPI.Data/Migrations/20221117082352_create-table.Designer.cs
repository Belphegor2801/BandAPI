...
namespace BandAPI.Data.Migrations
{
    ...
    [Migration("20221117082352_create-table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BandAPI.Data.Entities.Album", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BandAPI.Data.Entities.Band", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BandAPI.Data.Entities.Album", b =>
                {
                    b.HasOne("BandAPI.Data.Entities.Band", "Band")
                        .WithMany("Albums")
